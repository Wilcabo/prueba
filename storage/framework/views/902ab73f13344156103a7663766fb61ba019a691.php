...
<div class="mcw" >
  ...
  <div class="cv">
    ...
    <form action="<?php echo e(route('nuevotask')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="status" name="status">
                ...
                <option value="completada" <?php echo e(old('status') == 'completada' ? 'selected' : ''); ?>>Completada</option>
            </select>
        </div>
        <div class="form-group">
...
<?php /**PATH C:\prueba\resources\views/task/newtask.blade.php ENDPATH**/ ?>